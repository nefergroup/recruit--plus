    ...
    <div className="w-full min-h-screen bg-primary font-primary">
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="relative mb-16">
          {/* Badge */}
          <div className="absolute -top-3 left-48 bg-teal-400 text-white px-4 py-2 text-xs font-medium shadow-md z-10">
          ...
          {/* Main Card */}
          <div className="bg-teal-200/60 rounded-2xl p-8 pt-10 shadow-lg">
