...
import recruit from '../assets/images/recruit-logo.png'
    ...
    return (
        <div className="w-full flex justify-center items-center relative bg-primary py-10">
            ...
            <div className="relative z-10 max-w-3xl w-full mx-auto px-6 md:px-0 mt-10">
                ...
                {/* Center round image with Recruit logo */}
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-accent-blue shadow-lg bg-white">
                        <img
                            src={recruit}
                            alt="Recruit Logo"
