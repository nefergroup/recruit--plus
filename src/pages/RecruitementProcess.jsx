...
import bgImage from "../assets/images/recruit-about.jpg"; // use your image path
  ...
  return (
    ...
    <div className="relative w-full bg-primary text-primary font-primary overflow-hidden">
      <section className="max-w-5xl mx-auto px-6 md:px-10 pt-16 pb-4 relative z-10">
        <h2 className="font-heading text-4xl md:text-4xl text-secondary mb-4">Our Recruitment Process</h2>
        <h3 className="font-primary-bold italic text-third-text text-lg mb-4">Bridging the Skills Gap Across Europe</h3>
      ...
      <div className="absolute left-0 bottom-0 w-full h-[36vh] sm:h-[40vh] bg-cover bg-center z-0 mt-10"
        style={{
          backgroundImage: `linear-gradient(rgba(233,247,253,0.3), rgba(233,247,253,0.92)), url(${bgImage})`,
        }}>
      </div>

      {/* Dark Box, overlapping background image */}
      <div className="absolute left-1/2 transform -translate-x-1/2"
        style={{
          bottom: `calc(36vh - 20%)`, // 80% of the box above image, 20% inside
          width: "90%",
          maxWidth: "900px"
        }}
      >
        <div className="bg-[#434f6b] text-white  p-7 md:p-10 shadow-lg">
          <ul className="space-y-5 font-primary-light text-sm md:text-base leading-relaxed">
            <li>
      ...
      {/* Spacer (Keeps layout space under background image) */}
